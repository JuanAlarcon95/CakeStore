...
$consulta = "SELECT * from otro WHERE TIPO='PERRO'";
...
<head>
    ...
    <title>Adopciones de perros</title>
</head>
    ...
    <div class="untree_co--site-wrap">
        <nav class="untree_co--site-nav js-sticky-nav">
            <div class="container d-flex align-items-center">
                <div class="logo-wrap">
                    <a href="index.html" class="untree_co--site-logo">Patitas a la Moda</a>
                </div>
                <div class="site-nav-ul-wrap text-center d-none d-lg-block">
                    <ul class="site-nav-ul js-clone-nav">
                        <li><a href="index.html">Inicio</a></li>
                        <li class="has-children active">
                            <a href="adopciones.php">Adoptar</a>
                            <ul class="dropdown">
                                <li><a href="adopcionesPerros.php">Perros</a></li>
                                <li><a href="adopcionesGatos.php">Gatos</a></li>
                                <li><a href="adopcionesOtros.php">Otros</a></li>
                            </ul>
                        </li>
                ...
                <div class="icons-wrap text-md-right">
                    ...
                    <ul class="icons-top d-none d-lg-block">
                        <li><a href="https://www.facebook.com/PatitasALaModa/?locale=es_LA"><span class="icon-facebook"></span></a></li>
        ...
        <main>
            ...
            while ($row = mysqli_fetch_row($all_product)) {
                ...
                <div class="card" style="width: 18rem; ">
                    ...
                    <div class="card-body">
                        <form action="usuario/formularioAdopcion.php" method="post">
                            <h5 class="card-title">
                                <?php echo $row[1]; ?>
                            </h5>
                            ...
                            <br>
                            <input type="submit" href="usuario/formularioAdopcion.php" class="btn btn-warning"
                                name="Adoptar" id="Adoptar" value="Adoptar">
                        </form>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h3 class="m-0 p-0">Donando también puedes <a href="donaciones.html"> AYUDAR</a></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 pr-md-5">
                        ...
                        <p><a href="quienesSomos.html" class="readmore">QUIERO SABER MÁS</a></p>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="index.html">Inicio</a></li>
                                    <li><a href="donaciones.html">Donaciones</a></li>
                                    <li><a href="adopciones.php">Adoptar</a></li>
                ...
                <div class="row mt-5 pt-5 align-items-center">
                    ...
                    <div class="col-md-6 text-md-right">
                        <ul class="icons-top icons-dark">
                            <li><a href="https://www.facebook.com/PatitasALaModa/?locale=es_LA"><span class="icon-facebook"></span></a></li>
                            <li><a href="https://twitter.com/home"><span class="icon-twitter"></span></a></li>
                            <li><a href="https://www.instagram.com/"><span class="icon-instagram"></span></a></li>
                        </ul>
                    </div>
                </div>
