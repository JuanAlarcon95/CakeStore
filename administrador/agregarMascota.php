      ...
      <div class="container">
        <div class="row justify-content-center text-center pt-5 pb-5">
          <div class="col-lg-8 section-heading" data-aos="fade-up">
            <h3 class="text-center">Agregar nueva mascota</h3>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-md-6 mx-auto my-auto">
              <table class="table">
                ...
                <tbody>
                  <form action="insertarMascotas.php" method="post" enctype="multipart/form-data">
                    <tr>
                      <th scope="row">Nombre</th>
                      <td><input type="text" class="form-control" name="nombreM" id="nombreM" /> </td>
                    </tr>
                    <tr>
                      <th scope="row">Raza</th>
                      <td><input type="text" class="form-control" name="razaM" id="razaM" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Sexo</th>
                      <td>
                        <select name="sexoM" id="sexoM" class="form-control">
                    ...
                    <tr>
                      ...
                      <td><input type="number" min="0" name="edadM" id="edadM" class="form-control" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Datos</th>
                      <td><textarea class="form-control" name="datosM" id="datosM"></textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr class="text-center">
                      <th scope="row" colspan="2"><input type="submit" value="    Guardar    " name="btn"
