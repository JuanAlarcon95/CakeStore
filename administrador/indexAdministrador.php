        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="site-nav-ul-wrap text-center d-none d-lg-block">
            <ul class="site-nav-ul js-clone-nav">
              <li class="active"><a href="indexAdministrador.php">Inicio</a></li>
              ...
              <li class="has-children">
                ...
                <ul class="dropdown">
                  ...
                  <li><a href="menuM.php"><i class="fas fa-cat" aria-hidden="true"></i>&nbsp;Menu de
                      mascotas</a></li>
                  <li><a href="menuN.php"><i class="fas fa-check-circle" aria-hidden="true"></i>&nbsp;Menu de
            ...
            <div class="row custom-row-02192 align-items-stretch">
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>
                  <p><a href="adopcionesA.php" class="readmore reverse">QUIERO ADOPTAR</a></p>
                  </p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>
                  <p><a href="donacionesA.php" class="readmore reverse">QUIERO DONAR</a></p>
                  </p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>
                  <p><a href="preguntasFrecuentesA.php" class="readmore reverse">TENGO DUDAS</a></p>
                  </p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>
                  <p><a href="quienesSomosA.php" class="readmore reverse">CONOCER MÁS</a></p>
                  </p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>Si tienes dudas sobre el sitio web, su funcionamiento o sobre las adopciones, aqui puedes encontrar
                    preguntas.</p>
                  <p>
                  <p><a href="preguntasFrecuentesA.php" class="readmore reverse">CONOCER MÁS</a></p>
                  </p>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
                <div class="media-29191 text-center h-100">
                  ...
                  <p>
                  <p><a href="quienesSomosA.html" class="readmore reverse">QUIERO SABER</a></p>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div class="post-entry-contents">
                    <h3><a href="adopcionesPerrosA.php">Thanos</a></h3>
                    <p>Macho. Talla chica. Aproximadamente 1 año. Super dócil. Castrado. Desparasitado. Vacunado. Super
                      guapo.</p>
                    <p><a href="adopcionesPerrosA.php" class="readmore">Ver más</a></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="suite-contents" data-jarallax-element="50">
                ...
                <div class="suite-excerpt">
                  <p>Afortunadamente, cada día cobra más importancia la adopción animal responsable, esto hace que sean
                    ...
                    calle.</p>
                  <p><a href="quienesSomosA.php" class="readmore">Ver más</a></p>
                </div>
              </div>
            </div>
              ...
              <div class="suite-contents" data-jarallax-element="50">
                ...
                <div class="suite-excerpt pr-5">
                  <p>A lo largo de la existencia de este refugio han existido muchos casos de exito, en donde una persona
                    ...
                    donando. </p>
                  <p><a href="donacionesA.php" class="readmore">CONOCER MÁS</a></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 text-center">
                <h3 class="m-0 p-0">Duele ver a ángeles siendo ignorados y sufriendo <a href="adopcionesA.php">ADOPTA -
                    AYUDA</a></h3>
              </div>
            </div>
          </div>
