...
if ($_SESSION['usuario']) { ?>
  ...
  <head>
    ...
    <title>Agregar solicitud de adopción</title>
  </head>
      ...
      <div class="container">
        <div class="row justify-content-center text-center pt-5 pb-5">
          <div class="col-lg-8 section-heading" data-aos="fade-up">
            <h3 class="text-center">Agregar solicitud de adopción</h3>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-6 mx-auto my-auto">
              <table class="table">
                <thead>
                  <tr>
                    <th>Campos</th>
                    <th>Datos a ingresar</th>
                  </tr>
                </thead>
                <tbody>
                  <form action="insertarNoti.php" method="post">
                    <tr>
                      <th scope="row">Usuario que quiere adoptar</th>
                      <td><input type="text" name="usuarioN" id="usuarioN" class="form-control" /> </td>
                    </tr>
                    <tr>
                      <th scope="row">Nombre del usuario</th>
                      <td><input type="text" name="nombreN" id="nombreN" class="form-control" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Telefono</th>
                      <td><input type="text" name="telefonoN" id="telefonoN" class="form-control" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Fecha de nacimiento</th>
                      <td><input type="date" name="fechaN" id="fechaN" class="form-control" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Domicilio</th>
                      <td><input type="text" name="domicilioN" id="domicilioN" class="form-control" /></td>
                    </tr>
                    <tr>
                      <th scope="row">Nombre de mascota que quieres adoptar</th>
                      <td><input type="text" name="nomN" id="nomN" class="form-control" /></td>
                      
                    </tr>
                    <tr>
                      <th scope="row">Raza de mascota que quieres adoptar</th>
                      <td><input type="text" name="razaN" id="razaN" class="form-control" /></td>
                      
                    </tr>
                    <tr class="text-center">
                      <th scope="row" colspan="2"><input type="submit" value="    Registrar    " name="insertar"
