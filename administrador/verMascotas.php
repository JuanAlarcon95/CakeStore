            ...
            <div class="container">
                <div class="row justify-content-center text-center pt-5 pb-5">
                    <div class="col-lg-8 section-heading" data-aos="fade-up">
                        <h3 class="text-center">Ver detalles de las mascotas</h3>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="nombreM" id="nombreM"
                                                value="<?php echo $nombre2; ?>" readonly /> </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Raza</th>
                                        <td><input type="text" class="form-control" name="razaM" id="razaM"
                                                value="<?php echo $raza2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Sexo</th>
                                        <td>
                                            <input type="text" name="sexoM" id="sexoM" class="form-control"
                                                value="<?php echo $sexo2; ?>" readonly />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Tamaño</th>
                                        <td>
                                            <input type="text" name="tamañoM" id="tamañoM" class="form-control"
                                                value="<?php echo $tam2; ?>" readonly />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Edad</th>
                                        <td><input type="number" min="0" name="edadM" id="edadM" class="form-control"
                                                value="<?php echo $edad2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Datos</th>
                                        <td><input type="text" class="form-control" name="datosM" id="datosM"
                                                value="<?php echo $datos2; ?>" readonly></textarea></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Tipo</th>
                                        <td>
                                            <input type="text" name="tipoM" id="tipoM" class="form-control"
                                                value="<?php echo $tipo2; ?>" readonly />
                                    ...
                                    <tr>
                                        <th>Imagen</th>
                                        <td>
                                            <img src="data:image/jpg;base64,<?php echo "" . base64_encode($img2) ?>"
                                                height="330" />
                                        </td>
                                    ...
                                    <tr class="text-center">
                                        <form action="menuM.php">
                                            <th scope="row" colspan="2"><input type="submit" value="    Regresar    "
                                                    name="btn" class="btn btn-primary" /></th>
                                        </form>
                                    </tr>
                                </tbody>
                            </table>
