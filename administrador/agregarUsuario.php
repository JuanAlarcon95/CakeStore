                                ...
                                <tbody>
                                    <form action="insertarU.php" method="post" enctype="multipart/form-data">
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="usuarioU2" id="usuarioU2" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Constraseña</th>
                                            <td><input type="text" class="form-control" name="passwordU2" id="passwordU2" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row">Email</th>
                                            <td><input type="text" class="form-control" name="emailU2" id="emailU2" /></td>
                                        </tr>
                                        <tr>

                                        <tr class="text-center">
                                            <th scope="row" colspan="2"><input type="submit" value="    Guardar    "
