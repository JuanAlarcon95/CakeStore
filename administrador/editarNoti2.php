...
if ($_SESSION['usuario']) { ?>
    ...
    <head>
        ...
        <title>Editar solicitud de formularios</title>
    </head>
            ...
            <div class="container">
                <div class="row justify-content-center text-center pt-5 pb-5">
                    <div class="col-lg-8 section-heading" data-aos="fade-up">
                        <h3 class="text-center">Editar datos de los formularios recibidos</h3>
                    </div>
                </div>
            </div>
