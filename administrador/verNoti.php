    ...
    <body>
        ...
        <div class="untree_co--site-wrap">
            ...
            <div class="container">
                <div class="row justify-content-center text-center pt-5 pb-5">
                    <div class="col-lg-8 section-heading" data-aos="fade-up">
                        <h3 class="text-center">Ver detalles de los formularios recibidos</h3>
                    </div>
                </div>
            </div>
            ...
            if (isset($_POST['detalles'])) {
                $usuario2 = $_POST['usus2'];
                $adopciones2 = $_POST['adops2'];
                $selet = "SELECT * from formulario where usuario='" . $usuario2 . "' and adopcion='" . $adopciones2 . "'";
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="usuarioN" id="usuarioN"
                                                value="<?php echo $usuariou2; ?>" readonly /> </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Nombre completo</th>
                                        <td><input type="text" class="form-control" name="nombreN" id="nombreN"
                                                value="<?php echo $nombreu2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Telefono</th>
                                        <td><input type="text" class="form-control" name="telefonoN" id="telefonoN"
                                                value="<?php echo $telefonou2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Fecha de nacimiento</th>
                                        <td><input type="text" class="form-control" name="fechaN" id="fechaN"
                                                value="<?php echo $fechau2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Domicilio</th>
                                        <td><input type="text" class="form-control" name="domicilioN" id="domicilioN"
                                                value="<?php echo $domiciliou2; ?>" readonly /></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Mascota que quieran adoptar</th>
                                        <td><input type="text" class="form-control" name="adopcionN" id="adopcionN"
                                                value="<?php echo $adopcionesu2; ?>" readonly /></td>
                                    </tr>
                                    <tr class="text-center">
                                        <th scope="row" colspan="2"><a href="menuN.php"><input type="button"
                                                    value="    Regresar    " name="regresar" class="btn btn-success" /></a>
                                        </th>
