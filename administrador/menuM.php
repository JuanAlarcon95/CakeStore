            ...
            <main>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <form action="agregarMascota.php">
                                <input type="submit" value="Agregar mascota + " class="btn btn-primary btn-block" />
                            </form>
                        </div>
                    </div>
                </div>
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $consult = "SELECT * FROM otro where nombre='" . $busqueda . "' or raza='" . $busqueda . "' ";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <form action="verMascotas.php" method="post">
                                <input type="hidden" name="nombreM2" id="nombreM22" value="<?php echo $ra2[1]; ?>">
                                <input type="hidden" name="razaM2" id="razaM2" value="<?php echo $ra2[2]; ?>">
                                <td><input type="<?php echo $boton1 ?>" class="btn btn-warning" name="detalles"
                                        id="detalles" value="Ver detalles"></td>
                            </form>
                            <form action="borrarMascota.php" method="post">
                                <input type="hidden" name="nombreM2" id="nombreM2" value="<?php echo $nombre; ?>">
                                <input type="hidden" name="razaM2" id="razaM2" value="<?php echo $raza; ?>">
                                <td><input type="<?php echo $boton2 ?>" class="btn btn-danger" name="eliminar"
                                        value="Eliminar"></td>
                            </form>
                            <form action="editarMascotas.php" method="post">
                                <input type="hidden" name="nombreM2" id="nombreM22" value="<?php echo $ra2[1]; ?>">
                                <input type="hidden" name="razaM2" id="razaM2" value="<?php echo $ra2[2]; ?>">
                                <td><input type="<?php echo $boton3 ?>" class="btn btn-warning" name="editar" id="editar"
                                        value="Editar"></td>
                            </form>
                        </tr>
                    </tbody>
                ...
                <div class="container">
                    <div class="row justify-content-center text-center pt-5 pb-5">
                        <div class="col-lg-8 section-heading">
                            <h3 class="text-center">Todas las mascotas</h3>
                        </div>
                    </div>
                </div>

                <?php
                $consult2 = "SELECT * FROM otro";
