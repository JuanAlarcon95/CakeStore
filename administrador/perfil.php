...
if ($_SESSION['usuario']) { ?>
    ...
    $consulta3 = "SELECT*FROM formulario where usuario='" . $usuario . "'";
    ...
    if (empty($resultado3)) {
        ...
        $men1 = " ";
        $notificacion = " No hay notificaciones";
        $color = " ";
        $adopcion = "";
    }
            ...
            <div class="container">
                <div class="row justify-content-center text-center pt-5 pb-5">
                    <div class="col-lg-8 section-heading" data-aos="fade-up">
                        ...
                        <strong>¡Bienvenida
                            <?php echo $usuario ?>, estamos muy felices de tenerte por aqui!
                        </strong>
                    </div>
                </div>
            </div>
                    ...
                    <div class=" text-center">
                        ...
                        <div class="card-body">
                            <img src="data:image/jpg;base64,<?php echo "" . base64_encode($img) ?>"
                                class="rounded-circle z-depth-0" alt="avatar image" height="150" /><br>&nbsp; <br>&nbsp;
                            <div class="form-group">
                                <form action="imagen.php" method="post" enctype="multipart/form-data">
                                    <p>Ingresa o cambia tu foto de perfil : </p>
                                    <input type="file" name="foto" id="foto">
                                    <input type="hidden" name="user" id="user" value="<?php echo $usuario; ?>" />
                                    <input type="submit" name="enviar" id="enviar" value="Guardar imagen"
                            ...
                            <h4 class="card-text">Email :
                                <?php echo $email ?>
                            </h4>
                            <h4 class="card-text">Password :
                                <?php echo $pass ?>
                            </h4>
