            ...
            <main>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <a href="agregarUsuario.php"><button type="button" class="btn btn-primary btn-block">Agregar
                                    Usuario +</button></a>
                        </div>
                    </div>
                </div>
                ...
                if (isset($_GET['enviar'])) {
                    ...
                    $consult = "SELECT * FROM prueba where usuario='" . $busqueda . "'";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <form action="borrarUsuario.php" method="post">
                                <input type="hidden" name="usuario2" id="usuario2" value="<?php echo $usu; ?>">
                                <input type="hidden" name="email2" id="email2" value="<?php echo $emai; ?>">
                                <td><input type="<?php echo $boton1 ?>" class="btn btn-danger" name="eliminar"
                                        value="Eliminar USUARIO"></td>
                            </form>
                            <form action="editarUsuarios.php" method="post">
                                <input type="hidden" name="usuarioU2" id="usuarioU2" value="<?php echo $usu; ?>">
                                <input type="hidden" name="emailU2" id="emailU2" value="<?php echo $emai;
                                ; ?>">
                                <input type="hidden" name="passU2" id="passU2" value="<?php echo $pas; ?>">
                                <td><input type="<?php echo $boton2 ?>" class="btn btn-warning" name="editar" id="editar"
                                        value="Editar DATOS"></td>
                            </form>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="container">
                    <div class="row justify-content-center text-center pt-5 pb-5">
                        <div class="col-lg-8 section-heading">
                            <h3 class="text-center">Todos los usuarios registrados</h3>
                        </div>
                    </div>
                </div>

                <?php
                $consult2 = "SELECT * FROM prueba";
                    ...
                    while ($ra2 = mysqli_fetch_row($result2)) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <form action="borrarUsuario.php" method="post">
                                    <input type="hidden" name="usuario2" id="usuario2" value="<?php echo $ra2[0]; ?>">
                                    <input type="hidden" name="email2" id="email2" value="<?php echo $ra2[2]; ?>">
                                    <td><input type="submit" class="btn btn-danger" name="eliminar" value="Eliminar USUARIO">
                                    </td>
                                </form>
                                <form action="editarUsuarios.php" method="post">
                                    <input type="hidden" name="usuarioU2" id="usuarioU2" value="<?php echo $ra2[0]; ?>">
                                    <input type="hidden" name="emailU2" id="emailU2" value="<?php echo $ra2[2]; ?>">
                                    <td><input type="submit" class="btn btn-warning" name="editar" id="editar"
                                            value="Editar DATOS"></td>
                                </form>
                            </tr>
                        </tbody>
