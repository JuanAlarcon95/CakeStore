...
if ($_SESSION['usuario']) { ?>
    ...
    <head>
        ...
        <title>Menu de formularios enviados</title>
    </head>
            ...
            <main>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md">
                            <a href="agregarNoti.php"><button type="button" class="btn btn-primary btn-block">Agregar
                                    notificacion +</button></a>
                        </div>
                    </div>
                </div>
                ...
                <table class="table">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">Mascota a la que quiere adoptar</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <form action="borrarNoti2.php" method="post">
                            ...
                            <form action="editarNoti2.php" method="post">
                                <input type="hidden" name="usu2" id="usu2" value="<?php echo $usu; ?>">
                                <input type="hidden" name="adop2" id="adop2" value="<?php echo $adopcion; ?>">
                                <td><input type="<?php echo $boton2 ?>" class="btn btn-warning" name="editar" id="editar"
                                        value="Editar"></td>
                            </form>
                            <form action="verNoti.php" method="post">
                                <input type="hidden" name="usus2" id="usus2" value="<?php echo $usu; ?>">
                                <input type="hidden" name="adops2" id="adops2" value="<?php echo $adopcion; ?>">
                                <td><input type="<?php echo $boton3 ?>" class="btn btn-warning" name="detalles"
                                        id="detalles" value="Ver detalles"></td>
                            </form>
                        </tr>
                    </tbody>
                </table>
                    ...
                    while ($ra2 = mysqli_fetch_row($result2)) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <form action="editarNoti2.php" method="post">
                                    <input type="hidden" name="usu2" id="usu2" value="<?php echo $ra2[0]; ?>">
                                    <input type="hidden" name="adop2" id="adop2" value="<?php echo $ra2[5]; ?>">
                                    <td><input type="submit" class="btn btn-warning" name="editar" id="editar" value="Editar">
                                    </td>
                                </form>
                                <form action="verNoti.php" method="post">
                                    <input type="hidden" name="usus2" id="usus2" value="<?php echo $ra2[0]; ?>">
                                    <input type="hidden" name="adops2" id="adops2" value="<?php echo $ra2[5]; ?>">
                                    <td><input type="submit" class="btn btn-warning" name="detalles" id="detalles"
                                            value="Ver detalles"></td>
                                </form>
                            </tr>
                        </tbody>
                        <?php
